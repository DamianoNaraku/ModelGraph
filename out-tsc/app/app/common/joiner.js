...
export { ShortAttribETypes, U, Json, AttribETypes, InputPopup, DetectZoom, Dictionary, MeasurableArrays, IPoint, Point, GraphPoint, ISize, Size, GraphSize, myFileReader } from './util';
...
export var ansiUp = new AnsiUp(); // https://github.com/drudru/ansi_up // ansi color formatter.
import * as stringsimilarity from '../../app/common/StringSimilarity.js';
export var StringSimilarity = stringsimilarity;
import * as $$ from 'jquery';
export var $ = $$;
import * as JQueryUII from '../../node_modules/jquery-ui';
export var JQueryUI = JQueryUII;
import * as _pr_json2xml from '../common/prj_json2xml.js';
import * as _pr_xml2json from '../common/prj_xml2json.js';
export var prjson2xml = _pr_json2xml;
export var prxml2json = _pr_xml2json;
