...
var PropertyBarr = /** @class */ (function () {
    ...
    PropertyBarr.prototype.show = function (modelPiece) {
        console.log('PropertyBar.show: ', modelPiece);
    ...
    PropertyBarr.prototype.getA = function (o, templateContainer) {
        ...
        U.clear(selectType);
        PropertyBarr.makePrimitiveTypeSelector(selectType, U.getLongTypeName(o.type));
        $(selectType).off('change.pbar').on('change.pbar', function (evt) {
            var target = evt.currentTarget;
            o.setType(U.getShortTypeName(U.getPrimitiveType(target.value)));
        });
        return html;
    };
    return PropertyBarr;
