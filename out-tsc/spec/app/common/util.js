...
var U = /** @class */ (function () {
    ...
    U.getShortTypeName = function (type) {
        switch (type) {
            default:
                U.pe(true, 'unexpected type:', type);
                break;
            case AttribETypes.EString: return ShortAttribETypes.EString;
            case AttribETypes.integer: return ShortAttribETypes.integer;
        }
    };
    U.getLongTypeName = function (type) {
        switch (type) {
            default:
                U.pe(true, 'unexpected type:', type);
                break;
            case ShortAttribETypes.EString: return AttribETypes.EString;
            case ShortAttribETypes.integer: return AttribETypes.integer;
        }
    };
    /**
    ...
    U.findMetaParentP = function (parent, childJson) {
        return undefined;
    };
    U.findMetaParentC = function (parent, childJson) {
        return undefined;
    };
    U.findMetaParentA = function (parent, childJson) {
        return undefined;
    };
    U.findMetaParentR = function (parent, childJson) {
        return undefined;
    };
    U.sizeofvar = null;
    U.$sizeofvar = null;
